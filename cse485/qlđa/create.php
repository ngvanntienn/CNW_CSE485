...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO do_an (ten_de_tai, ten_sinh_vien, mssv, giang_vien_hd, nam_hoc, trang_thai)
    VALUES ('$ten_de_tai', '$ten_sinh_vien', '$mssv', '$giang_vien_hd', '$nam_hoc', '$trang_thai')";
